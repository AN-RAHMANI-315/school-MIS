...
terraform {
  ...
  # After running scripts/setup-terraform-backend.sh, you can migrate to S3 backend
  # by uncommenting the s3 backend block below and running: terraform init -migrate-state
